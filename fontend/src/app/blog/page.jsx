...
//                 <ul>
//                     <li onClick={()=>{setTab("CHATROOM")}} className={`styles.member ${tab==="CHATROOM" && "active"}`}>Chatroom</li>
//                     {[...privateChats.keys()].map((name,index)=>(
//                         <li onClick={()=>{setTab(name)}} className={`styles.member ${tab===name && "active"}`} key={index}>{name}</li>
//                     ))}
//                 </ul>
//             </div>
...
//                         <li className={`styles.message ${chat.senderName === userData.username && "self"}`} key={index}>
//                             {chat.senderName !== userData.username && <div className={styles.avatar}>{chat.senderName}</div>}
//                             <div className="message-data">{chat.message}</div>
//                             {chat.senderName === userData.username && <div className={styles.avatarself}>{chat.senderName}</div>}
//                         </li>
//                     ))}
//                 </ul>
